...
# This loads a template called polls/index.html and passes it a context.
...
def detail(request, question_id):
    ...
    # Edited to use the pub_date filter to check if the pub_date is in the past
    # and not in a future date
...
def vote(request, question_id):
    ...
    try:
        ...
        # The reverse() (a very bad name) function is a shortcut to avoid hardcoding a URL in the view.
